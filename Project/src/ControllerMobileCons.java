...
public class ControllerMobileCons implements Initializable{
    ...
    public void loadList() {
        ...
        appData.load("Consoles", (result) -> {
            if (result == null) {
            System.out.println("ControllerMobileCons: Error loading data.");
            } else {

            try {
                showList();
            } catch (Exception e) {
                System.out.println("ControllerMobileCons: Error showing list.");
            }
            }
        });
    }
    ...
    public void showList() throws Exception{
        ...
        JSONArray dades = appData.getData("Consoles");
